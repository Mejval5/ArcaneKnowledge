...
{
    [Serialized]
    [LocDisplayName("Arcane Living Circle")]
    [Ecopedia("Work Stations", "Craft Tables", createAsSubPage: true)]
    [AllowPluginModules(Tags = new[] { "AdvancedUpgrade" }, ItemTypes = new Type[] {typeof (ArcaneUpgradeItem)})]
    public partial class ArcaneLivingCircleItem : WorldObjectItem<ArcaneLivingCircleObject>, IPersistentData
    {
        public override LocString DisplayDescription => Localizer.DoStr("An arcane circle where you can sacrifice unliving Livings.");
