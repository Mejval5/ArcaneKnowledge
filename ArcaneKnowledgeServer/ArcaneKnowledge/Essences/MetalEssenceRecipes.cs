...
namespace Eco.Mods.TechTree
{
    ...
    public class ConcentratedOreSacrificeForEssenceRecipe : RecipeFamily
    {
        // Properties
        ...
        // Output
        private CraftingElement CraftingOutput => new CraftingElement<MetalEssenceItem>(OutputAmount);

        public ConcentratedOreSacrificeForEssenceRecipe()
        {
            InitializeRecipe();
        }
    ...
    public class GearSacrificeForEssenceRecipe : RecipeFamily
    {
        ...
        public GearSacrificeForEssenceRecipe()
        {
            InitializeRecipe();
        }
    ...
    public class MetalSacrificeForEssenceRecipe : RecipeFamily
    {
        ...
        public MetalSacrificeForEssenceRecipe()
        {
            InitializeRecipe();
        }
    ...
    public class OreSacrificeForEssenceRecipe : RecipeFamily
    {
        // Properties
        ...
        public OreSacrificeForEssenceRecipe()
        {
            InitializeRecipe();
        }
