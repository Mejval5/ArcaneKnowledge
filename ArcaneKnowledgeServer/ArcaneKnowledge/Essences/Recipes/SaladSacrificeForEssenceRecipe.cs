...
namespace Eco.Mods.TechTree
{
    ...
    public class SaladSacrificeForEssenceRecipe : RecipeFamily
    {
        // Settings:                                     Ratio, Xp, Time, Labor
        private static float[] Settings => new float[] { 0.3f, 0.8f, 1.2f, 60f };
        
        // Input
        private IngredientElement Ingredient => new IngredientElement(
            "Salad", SourceAmount, typeof(ArcaneKnowledgeSkill), typeof(ArcaneKnowledgeLavishReqTalent)
        );
        ...
        public SaladSacrificeForEssenceRecipe()
        {
            InitializeRecipe();
        }
