...
namespace Eco.Mods.TechTree
{
    ...
    public class CookingSkillScrollRecipe : RecipeFamily
    {
        // Settings: Time,Labor,XP,Life,Food,Metal,Fire,Earth,Nature,Research
        private static float[] Settings => new float[] { 15f, 750f, 25f, 155f, 45f, 340f, 40f, 60f, 30f, 40f };
        private CraftingElement CraftingOutput => new CraftingElement<CookingSkillScroll>(1);

        public CookingSkillScrollRecipe()
        {
            InitializeRecipe();
        }
