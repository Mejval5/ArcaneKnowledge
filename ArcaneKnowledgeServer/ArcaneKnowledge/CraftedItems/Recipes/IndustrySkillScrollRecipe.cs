...
namespace Eco.Mods.TechTree
{
    ...
    public class IndustrySkillScrollRecipe : RecipeFamily
    {
        // Settings: Time,Labor,XP,Life,Food,Metal,Fire,Earth,Nature,Research
        private static float[] Settings => new float[] { 50f, 42000f, 335f, 460f, 580f, 3610f, 630f, 575f, 1210f, 300f };
        private CraftingElement CraftingOutput => new CraftingElement<IndustrySkillScroll>(1);

        public IndustrySkillScrollRecipe()
        {
            InitializeRecipe();
        }
